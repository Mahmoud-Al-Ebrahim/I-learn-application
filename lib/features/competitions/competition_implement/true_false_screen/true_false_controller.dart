...
class TrueFalseQuestionController extends GetxController
  ...
  final List<Question> _questions =  trueFalseDate.map(
        (question) => Question(
        id: question['id'],
  ...
  void onInit() {
    ...
    _animationController =
        AnimationController(duration: const Duration(seconds: 180), vsync: this);
  ...
  void nextQuestion() {
    if (_questionNumber.value != _questions.length) {
      ...
      Get.to(const CompetitionScoreBoard());
    }
  }
